...
@click.option("--telegram-chatid", help="Telegram chat id")
...
def cli(
    ...
    wg_gesucht = WgGesuchtCrawler(
        login_info, wg_ad_links, offline_ad_links, logs_folder, filter_names, share_email, cookie_file, telegram_token, telegram_chatid
    )
